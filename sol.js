...
function Planet(r, x, y, vx, vy) {
  ...
  this.getMassFromRadius = function(r) {
    return this.DENSITY * Math.PI * Math.pow(this.radius, 3.0) * (4.0 / 3.0);
  };

  this.getRadiusFromMass = function(m) {
  ...
  this.acceleration = function(state, planets) {
    var ax = 0.0, ay = 0.0;
    var dx, dy, d, d2;
  ...
  this.update = function(planets, dt) {
